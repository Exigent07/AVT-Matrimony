...
const TERM_TRANSLATIONS: Record<string, { en: string; ta: string }> = {
  ...
  affluent: { en: "Affluent", ta: "வளமான குடும்பம்" },
  athletic: { en: "Athletic", ta: "உடற்பயிற்சி உடல்" },
  average: { en: "Average", ta: "சாதாரண உடல்" },
  "below ₹3 lakhs": { en: "Below ₹3 Lakhs", ta: "₹3 லட்சத்திற்கு கீழ்" },
  citizen: { en: "Citizen", ta: "குடியுரிமையாளர்" },
  blocked: { en: "Blocked", ta: "தடைசெய்யப்பட்டது" },
  "business / self employed": { en: "Business / Self Employed", ta: "வணிகம் / சுயதொழில்" },
  ...
  "defense / civil services": { en: "Defense / Civil Services", ta: "பாதுகாப்பு / சிவில் சேவைகள்" },
  ...
  "differently abled": { en: "Differently Abled", ta: "மாற்றுத்திறனாளி" },
  divorced: { en: "Divorced", ta: "விவாகரத்து" },
  dusky: { en: "Dusky", ta: "கருந்தேகம்" },
  eggetarian: { en: "Eggetarian", ta: "முட்டை சைவம்" },
  female: { en: "Female", ta: "பெண்" },
  fair: { en: "Fair", ta: "வெண்மை" },
  "fake profile": { en: "Fake Profile", ta: "போலி சுயவிவரம்" },
  "government / public sector": { en: "Government / Public Sector", ta: "அரசு / பொதுத்துறை" },
  harassment: { en: "Harassment", ta: "தொல்லை" },
  heavy: { en: "Heavy", ta: "பருமனான உடல்" },
  home: { en: "Home", ta: "முகப்பு" },
  "in progress": { en: "In Progress", ta: "செயல்பாட்டில்" },
  "inappropriate behavior": { en: "Inappropriate Behavior", ta: "ஒழுங்கற்ற நடத்தை" },
  "joint family": { en: "Joint Family", ta: "கூட்டுக் குடும்பம்" },
  male: { en: "Male", ta: "ஆண்" },
  member: { en: "Member", ta: "உறுப்பினர்" },
  "middle class": { en: "Middle Class", ta: "நடுத்தர வர்க்கம்" },
  ...
  never: { en: "Never", ta: "இல்லை" },
  "non vegetarian": { en: "Non Vegetarian", ta: "அசைவம்" },
  ...
  "not working": { en: "Not Working", ta: "வேலை செய்யவில்லை" },
  "nuclear family": { en: "Nuclear Family", ta: "தனிக்குடும்பம்" },
  occasionally: { en: "Occasionally", ta: "அவ்வப்போது" },
  open: { en: "Open", ta: "திறந்துள்ளது" },
  other: { en: "Other", ta: "மற்றவை" },
  pending: { en: "Pending", ta: "நிலுவையில்" },
  "permanent resident": { en: "Permanent Resident", ta: "நிரந்தர வசிப்பாளர்" },
  "profile complete": { en: "Profile Complete", ta: "சுயவிவரம் முழுமை" },
  "private company": { en: "Private Company", ta: "தனியார் நிறுவனம்" },
  rejected: { en: "Rejected", ta: "நிராகரிக்கப்பட்டது" },
  regularly: { en: "Regularly", ta: "வழக்கமாக" },
  ...
  slim: { en: "Slim", ta: "மெலிந்த உடல்" },
  "student visa": { en: "Student Visa", ta: "மாணவர் விசா" },
  vegan: { en: "Vegan", ta: "வேகன்" },
  vegetarian: { en: "Vegetarian", ta: "சைவம்" },
  widowed: { en: "Widowed", ta: "விதவை / விதவன்" },
  wheatish: { en: "Wheatish", ta: "கோதுமை நிறம்" },
  "work permit": { en: "Work Permit", ta: "வேலை அனுமதி" },
  "upper middle class": { en: "Upper Middle Class", ta: "மேல் நடுத்தர வர்க்கம்" },
  "₹3-5 lakhs": { en: "₹3-5 Lakhs", ta: "₹3-5 லட்சம்" },
  "₹5-7 lakhs": { en: "₹5-7 Lakhs", ta: "₹5-7 லட்சம்" },
  "₹8-10 lakhs": { en: "₹8-10 Lakhs", ta: "₹8-10 லட்சம்" },
  "₹10-15 lakhs": { en: "₹10-15 Lakhs", ta: "₹10-15 லட்சம்" },
  "₹15-18 lakhs": { en: "₹15-18 Lakhs", ta: "₹15-18 லட்சம்" },
  "₹18-22 lakhs": { en: "₹18-22 Lakhs", ta: "₹18-22 லட்சம்" },
  "₹22-30 lakhs": { en: "₹22-30 Lakhs", ta: "₹22-30 லட்சம்" },
  "₹30+ lakhs": { en: "₹30+ Lakhs", ta: "₹30 லட்சத்திற்கு மேல்" },
};
